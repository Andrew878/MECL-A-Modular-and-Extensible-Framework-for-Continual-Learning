...
class DataSetAndInterface:
    ...
    def obtain_dataloader_with_subset_of_categories(self, branch_component, split, category_subset, BATCH_SIZE = 64, num_workers=4):
        ...
        return self.return_data_loaders(branch_component,self.obtain_dataset_with_subset_of_categories(branch_component,split, category_subset),BATCH_SIZE,num_workers)
