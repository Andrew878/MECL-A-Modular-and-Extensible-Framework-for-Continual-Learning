      ...
      #      print(idx)
          ...
          #      print(subset_dataset[d_set][branch_component].targets)
           ...
           #     print("idx",idx)
            ...
            # print(subset_dataset[d_set][branch_component].data)
            # print(subset_dataset[d_set][branch_component].data[0])
    ...
    def add_outside_data_to_data_set(self, datasetAndInterfaceTwo, sub_set_list_cats_two=[]):
        ...
        for model in ['VAE', 'CNN']:
            ...
            for split in ['train', 'val']:
                subset_dataset_two.targets = subset_dataset_two.targets + self.num_categories
                self.dataset[split][model] = torch.utils.data.ConcatDataset([self.dataset, datasetAndInterfaceTwo.dataset])
